...
namespace ProyectoFinal.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Contacto(Contacto contacto)
        {
            ...
            rule.SendEmail(contacto.Email, mensaje, "Mensaje Recibido", "Federico Almaraz", "federicoalmaraz@gmail.com");
            rule.SendEmail("federicoalmaraz37@gmail.com", contacto.Mensaje, "Nuevo contacto", contacto.Nombre, contacto.Email);
